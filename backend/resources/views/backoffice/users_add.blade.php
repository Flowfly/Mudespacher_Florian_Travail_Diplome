        ...
        <div class="col-12">
            ...
            <form action="/backoffice/post-user" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control {{$errors->has('phone') ? 'is-invalid' : ''}}" id="phone"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{$errors->has('surname') ? 'is-invalid' : ''}}" id="surname"
                           name="surname" value="{{old('name')}}">
